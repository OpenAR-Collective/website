...
A direct word on AI-assisted development: the platform is not being written by AI in any unsupervised sense. Every line of code, whether drafted by a human or by an AI tool with a human at the keyboard, is reviewed, tested, and approved by qualified human developers before it becomes part of the software. Architecture, security, and compliance decisions are set by humans under formal governance. AI is a productivity tool here; the judgment and accountability stay with the people responsible.
